      ...
      .then(data => {
        if (data && data.ads) {
          ...
          setStats({
            ...
            notice: data.notice || "Welcome to your Village Coordinator Portal."
          });
        }
        setLoading(false);
      })
      ...
      <main className="flex-1 px-4 py-8 max-w-6xl mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <p className="text-xs font-bold text-gray-400 tracking-widest uppercase mt-1">
            Logged in as: <span className="text-blue-600">{user?.fullName || 'Coordinator'}</span> • {user?.village || 'Village Area'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl border border-steppergold/50 shadow-md flex flex-col hover:border-steppergold transition-colors cursor-default relative overflow-hidden">
             ...
             <div className="flex items-center justify-between mb-4">
                 <h4 className="text-[10px] sm:text-xs font-black text-navy uppercase tracking-widest leading-relaxed pr-2">Reader Comm.<span className="hidden sm:inline"> (18%)</span></h4>
             ...
             <p className="text-[10px] font-bold text-navy uppercase tracking-widest mt-2">Earned via Subscriptions</p>
          </div>

          <div className="bg-white p-6 rounded-xl border border-steppergold/50 shadow-md flex flex-col hover:border-steppergold transition-colors cursor-default relative overflow-hidden">
             <div className="absolute top-0 right-0 w-16 h-16 bg-steppergold/5 rounded-bl-[100%]"></div>
             <div className="flex items-center justify-between mb-4">
                 <h4 className="text-[10px] sm:text-xs font-black text-navy uppercase tracking-widest leading-relaxed pr-2">Ad Comm.<span className="hidden sm:inline"> (18%)</span></h4>
             ...
             <p className="text-[10px] font-bold text-navy uppercase tracking-widest mt-2">Earned via News/Ads</p>
          </div>

          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col hover:border-blue-500 transition-colors cursor-default">
             <div className="flex items-center justify-between mb-4">
                 <h4 className="text-[10px] sm:text-xs font-black text-gray-400 uppercase tracking-widest leading-relaxed">Local Village Ads</h4>
             ...
             <p className="text-[10px] font-bold text-gray-400 uppercase mt-2">All time submissions</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col hover:border-blue-500 transition-colors cursor-default sm:col-span-2 xl:col-span-1">
             <div className="flex items-center justify-between mb-4">
                 <h4 className="text-[10px] sm:text-xs font-black text-gray-400 uppercase tracking-widest leading-relaxed">Active Live Ads</h4>
             ...
             <p className="text-[10px] font-bold text-gray-400 uppercase mt-2">Currently running</p>
          </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] md:text-xs font-black text-navy uppercase">Register New Reader</p>
            ...
            <div className="p-0 flex-1 overflow-y-auto">
              {readers.length === 0 ? (
                ...
                readers.map((reader, idx) => (
                  <div key={idx} className="p-4 border-b border-gray-50 flex justify-between items-center hover:bg-gray-50 transition-colors group">
                    <div>
                    ...
                    <div className="flex items-center gap-2">
                       <button 
                         ...
                         className="p-1.5 text-blue-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors opacity-0 group-hover:opacity-100"
                         title="Edit Reader"
                       >
                         <Edit2 size={14} />
                       </button>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-navy/80 backdrop-blur-sm animate-in fade-in duration-300 overflow-y-auto">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300 my-auto">
            ...
            <div className="p-6 md:p-8 flex flex-col gap-4 bg-gray-50">
              ...
              {/* Running Duration & Charges Matrix */}
              ...
              <button 
                onClick={() => {
                  ...
                  // Trigger universal payment gateway for News Ads
