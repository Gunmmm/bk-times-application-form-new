    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 px-4 py-8 max-w-6xl mx-auto w-full">
        <div className="mb-8">
          ...
          <p className="text-xs font-bold text-gray-400 tracking-widest uppercase mt-1">Logged in as: <span className="text-blue-600">{user?.fullName || 'Coordinator'}</span> • {user?.district || 'District Area'}</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-3 sm:gap-4 mb-8">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col hover:border-blue-500 transition-colors cursor-default relative overflow-hidden">
             <div className="flex items-start justify-between mb-2">
                 <h4 className="text-[9px] sm:text-[10px] md:text-xs font-black text-gray-400 uppercase tracking-widest leading-tight pr-4">District Readers</h4>
                 <Users className="text-blue-500 w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
             </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-steppergold/50 shadow-md flex flex-col hover:border-steppergold transition-colors cursor-default relative overflow-hidden">
             ...
             <p className="text-[8px] sm:text-[10px] font-bold text-navy uppercase tracking-widest mt-auto pt-2">Earned via Subs</p>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-steppergold/50 shadow-md flex flex-col hover:border-steppergold transition-colors cursor-default relative overflow-hidden">
             ...
             <p className="text-[8px] sm:text-[10px] font-bold text-navy uppercase tracking-widest mt-auto pt-2">Earned via Ads</p>
          </div>

          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col hover:border-blue-500 transition-colors cursor-default relative overflow-hidden">
             <div className="flex items-start justify-between mb-4">
                 <h4 className="text-[9px] sm:text-[10px] md:text-xs font-black text-gray-400 uppercase tracking-widest leading-tight pr-4">District Ads</h4>
          ...
          <div className="xl:col-span-1 flex flex-col gap-3">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] md:text-xs font-black text-navy uppercase">Register District Readers</p>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] md:text-xs font-black text-orange-900 uppercase">Register Taluka Reporters</p>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] md:text-xs font-black text-blue-900 uppercase">Register Village Reporters</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-white rounded-[2rem] shadow-md border border-orange-100 overflow-hidden flex flex-col h-64 lg:h-[450px]">
            <div className="p-4 md:p-6 border-b border-orange-50 flex items-center justify-between bg-orange-50/30">
              <h3 className="text-[10px] md:text-xs font-black text-orange-900 uppercase tracking-widest flex items-center gap-3">
                <Users className="text-orange-600" size={18} /> Taluka Reporters
              </h3>
              <span className="text-[8px] md:text-[10px] font-black text-orange-400 uppercase bg-white px-3 py-1.5 rounded-full shadow-sm border border-orange-50">Local Managers</span>
            </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-md border border-blue-100 overflow-hidden flex flex-col h-64 lg:h-[450px]">
            <div className="p-4 md:p-6 border-b border-blue-50 flex items-center justify-between bg-blue-50/30">
              <h3 className="text-[10px] md:text-xs font-black text-blue-900 uppercase tracking-widest flex items-center gap-3">
                <Users className="text-blue-600" size={18} /> Village Reporters
              </h3>
              <span className="text-[8px] md:text-[10px] font-black text-blue-400 uppercase bg-white px-3 py-1.5 rounded-full shadow-sm border border-blue-50">Field Force</span>
            </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-md border border-gray-100 overflow-hidden flex flex-col h-64 lg:h-[450px]">
             <div className="p-4 md:p-6 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                <h3 className="text-[10px] md:text-xs font-black text-navy uppercase tracking-widest flex items-center gap-3">
                  <Users className="text-green-500" size={18} /> District Readers
                </h3>
                <span className="text-[8px] md:text-[10px] font-black text-gray-400 uppercase bg-white px-3 py-1.5 rounded-full shadow-sm border border-gray-100">Live Repo</span>
             </div>
             <div className="p-0 flex-1 overflow-y-auto">
                {readers.length === 0 ? (
                  <div className="p-12 text-center text-gray-300 font-bold uppercase tracking-widest text-[10px] italic flex flex-col items-center gap-3">
      ...
      {/* Reader Modal */}
      {showReaderModal && (<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-navy/80 backdrop-blur-sm animate-in fade-in duration-300 overflow-y-auto"><div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300 my-auto"><div className="p-6 md:p-8 bg-steppergold text-navy flex justify-between items-center gap-4"><div className="flex-1"><h2 className="text-lg md:text-2xl font-black uppercase tracking-tight">{editingReaderId?'Update Reader':'Register New Reader'}</h2><p className="text-[8px] md:text-[10px] text-navy/80 font-black uppercase tracking-widest mt-1">District Coordinator Portal</p></div><button onClick={() => { setShowReaderModal(false); setEditingReaderId(null); setReaderForm({name:'',mobile:'',gender:'',education:'',address:'',district:'',taluka:'',village:'',pinCode:'',subscriptionPlan:'1_year',paymentAmount:1000}); }} className="w-8 h-8 md:w-10 md:h-10 bg-navy/10 hover:bg-navy/20 rounded-full flex shrink-0 items-center justify-center"><span className="font-bold text-navy text-sm">✕</span></button></div>
      ...
      {/* Receipt */}
      {receiptInfo && (<div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-navy/80 backdrop-blur-sm animate-in fade-in duration-300"><div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-sm p-6 flex flex-col items-center"><div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4"><CheckCircle className="text-green-500 w-8 h-8" /></div><h2 className="text-xl font-black text-navy uppercase text-center mb-1">Payment Successful</h2><p className="text-xs text-gray-500 font-bold uppercase text-center mb-6">{receiptInfo.transactionId}</p><div className="w-full space-y-3 mb-6 bg-gray-50 p-4 rounded-xl border border-gray-100"><div className="flex justify-between text-xs"><span className="font-bold text-gray-400 uppercase">{receiptInfo.transactionId.startsWith('AD_')?'Advertiser Name':'Reader Name'}</span><span className="font-black text-gray-800">{receiptInfo.name}</span></div><div className="flex justify-between text-xs"><span className="font-bold text-gray-400 uppercase">{receiptInfo.transactionId.startsWith('AD_')?'Ad Package':'Subscription'}</span><span className="font-black text-gray-800">{receiptInfo.plan.replace('_',' ').toUpperCase()}</span></div><div className="flex justify-between text-xs pt-3 border-t border-gray-200"><span className="font-bold text-gray-400 uppercase">Total Paid</span><span className="font-black text-navy text-sm">₹{receiptInfo.amount.toLocaleString()}</span></div></div><div className="w-full bg-steppergold/10 border-2 border-steppergold p-4 rounded-xl flex items-center justify-between mb-6"><span className="text-[10px] font-black text-navy uppercase tracking-widest">Your 18% Commission</span><span className="text-xl font-black text-steppergold">₹{receiptInfo.commission.toLocaleString(undefined,{maximumFractionDigits:0})}</span></div><button onClick={()=>setReceiptInfo(null)} className="w-full h-12 bg-navy text-steppergold rounded-xl font-black uppercase tracking-widest text-xs hover:bg-black transition-all shadow-lg active:scale-95">Close Receipt</button></div></div>)}

      {/* News Modal */}
      {showNewsModal && (<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-navy/80 backdrop-blur-sm animate-in fade-in duration-300 overflow-y-auto"><div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300 my-auto"><div className="p-6 md:p-8 bg-navy text-white flex justify-between items-center gap-4"><div className="flex-1"><h2 className="text-lg md:text-2xl font-black uppercase tracking-tight">Book News / Ad</h2><p className="text-[8px] md:text-[10px] text-steppergold font-black uppercase tracking-widest mt-1">District Coordinator Portal</p></div><button onClick={()=>{setShowNewsModal(false);setNewsForm({name:'',phone:'',pinCode:'',category:'Matrimonial',durationDays:1,content:'',paymentAmount:500,photo:null,customCategory:''}); }} className="w-8 h-8 md:w-10 md:h-10 bg-white/10 hover:bg-white/20 rounded-full flex shrink-0 items-center justify-center"><span className="font-bold text-sm">✕</span></button></div>
        <div className="p-6 md:p-8 flex flex-col gap-4 bg-gray-50">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4">
